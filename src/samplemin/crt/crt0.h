...
# define MINI_CRT0_IGNORED (MINI_CRT0_STRING_BYTE | MINI_CRT0_STDLIB_MEMORY)
#endif
...
#define MINI_CRT0_EXCEPTIONS      0x40  // _Xbad_alloc(), _Xinvalid_argument(), ...
#define MINI_CRT0_COM             0x80  // _com_issue_error(), _com_raise_error(), ...
